...
import LiftingResults, { cjAttempts, snatchAttempts, type AttemptKey } from "../types/liftingResults";
import type {
...
import { formatPercent, maxPositive, positiveValues } from "../utils/format";
import { movementRank } from "../utils/sortByMovement";

/* Search for club and meet and get full report 
 *
